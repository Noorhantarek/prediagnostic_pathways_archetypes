...
# Exploratory assessment of three pre-diagnostic pathway channels
# ==============================================================================
...
# cohort-construction / pathway-extraction workflow. They are intentionally not
...
# Dates should be parsed immediately after import.
...
# Keep the pre-diagnostic window used by the study.
...
# ------------------------------------------------------------------------------
# Aggregate QC only. Avoid printing individual patient records in public code.
...
# comparable across cancer groups without exposing hard-coded source results.
...
# term labels can be joined there for clinical review. Do not export restricted
# dictionary content unless explicitly permitted by the data provider.
